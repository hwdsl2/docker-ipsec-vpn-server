...
**Новинка:** Также доступно: [сервер WireGuard на Docker](https://github.com/hwdsl2/docker-wireguard/blob/main/README-ru.md) | [сервер OpenVPN на Docker](https://github.com/hwdsl2/docker-openvpn/blob/main/README-ru.md).
...
В качестве альтернативы вы можете [настроить IPsec VPN без Docker](https://github.com/hwdsl2/setup-ipsec-vpn/blob/master/README-ru.md). Также доступно: [сервер WireGuard на Docker](https://github.com/hwdsl2/docker-wireguard/blob/main/README-ru.md) | [сервер OpenVPN на Docker](https://github.com/hwdsl2/docker-openvpn/blob/main/README-ru.md). Чтобы узнать больше о том, как использовать этот образ, прочитайте разделы ниже.
