...
> [!IMPORTANT]
> In your `env` file, write values without surrounding quotes or spaces around `=`. Values must not contain `\`, `"`, or `'`. A secure IPsec PSK should consist of at least 20 random characters.
